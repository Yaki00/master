/** Accusés de réception immédiats pendant qu’une tâche longue tourne. */
...
/**
 * Vérifie grossièrement que la réponse finale répond à la demande
 * (anti-blocage / anti-hors-sujet évident).
 */
